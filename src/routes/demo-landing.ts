...
const statItems = `<span class="stat">Six months of contacts, sends, clicks, and channel activity — generated by a deterministic seed, so it always reads as current.</span>`;
...
const CARDS: { n: string; title: string; body: string }[] = [
  ...
  },
  {
    n: "03",
    title: "Campaigns",
    body: "Broadcast history plus scheduled sends, run through <code>defineCampaign()</code> — the Studio view shows status, audience, and per-send funnels.",
  },
  {
    n: "04",
    title: "Live buckets",
...
const ROUTE_STOPS: { n: string; title: string; body: string }[] = [
  {
    n: "01",
    title: "Journeys",
    body: "Enrollment, completion, and a per-journey funnel for every journey in the list above.",
  },
  {
    n: "02",
    title: "Sends",
    body: "Every email with delivered / opened / clicked / bounced state on each one.",
  },
  {
    n: "03",
    title: "Contacts",
    body: "Each person carries a cross-channel timeline — events, sends, bucket transitions.",
  },
  {
    n: "04",
  ...
  <main>
    <section class="hero">
      <div class="container hero-inner">
        ...
        <p class="lead">Forgeline is a fictional credit-based AI code-review product. This is a live Hogsend Studio wired to its story — contacts, lifecycle journeys, tracked emails, campaigns, and activity across email, in-app, Discord, and Telegram.</p>
        <div class="cta-row">
      ...
      <div class="container hero-tail">
        <div class="window">
          ...
          ${journeyRows}
          <p class="win-caption">The journeys running in this instance — every one fans out to email, the in-app feed, Discord, and Telegram.</p>
        </div>
      </div>
    </section>
